 ...
 */
 /* peter added a hack here to give us some pixels less height, in line 37 */
        ...
        return {
            link: function($scope, $element, $attrs) {
                ...
                angular.element($window).bind('resize', function() {
                    ...
                    if ($parent.length > 0) {
                      parentHeight -= $parent[0].getBoundingClientRect().top;
                    }
                    return $element.css('height', (parentHeight - combineHeights(siblings($element)) - additionalHeight - 14) + "px");
                });
