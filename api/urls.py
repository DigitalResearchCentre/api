...
urlpatterns = patterns(
    ...
    url(r'^communities/(?P<pk>\d+)/',
        include(APIView.urlpatterns([
            ...
            {'func': 'get_text_refsdecls', 'serializer_class': RefsDeclSerializer},
    ...
    url(r'^texts/(?P<pk>\d+)/',
        include(APIView.urlpatterns([
            ...
            {'func': 'get_urn', 'serializer_class': None},
            {'func': 'get_refsdecls', 'serializer_class': RefsDeclSerializer},
...
urlpatterns += static('/client', 
                        document_root=settings.BASE_DIR+ '/client')
urlpatterns += static('/interface',
                        document_root=settings.BASE_DIR+ '/interface')
